...
describe('stall watchdog', () => {
  test(
    'force-nudges a sensei stuck non-idle, then goes quiet once pending drains',
    async () => {
  ...
  test(
    'STANDS DOWN while a human is waiting, even before that episode has fired its first wake',
    async () => {
